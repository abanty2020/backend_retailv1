...
//########################################################
 ...
 $tableB=new easyTable($pdf,'%{10,25,15,20,15,15}','align:L{LC}; border:1; border-color:#BABABA; font-color:#000');

 $tableB->easyCell(utf8_decode("Ítem"), 'rowspan:1; valign:M; align:C; font-style:B');
 $tableB->easyCell(utf8_decode("Descripción"), 'rowspan:1; valign:M; align:C; font-style:B');
 $tableB->easyCell(utf8_decode("Cantidad"), 'rowspan:1; valign:M; align:C; font-style:B');
 $tableB->easyCell(utf8_decode("Árticulo"), 'rowspan:1; valign:M; align:C; font-style:B');
 $tableB->easyCell(utf8_decode("Precio Unitario US$"), 'rowspan:1; valign:M; align:C; font-style:B');
 $tableB->easyCell(utf8_decode("Sub Total US$"), 'rowspan:1; valign:M; align:C; font-style:B');
 $tableB->printRow();

 $tableB->endTable(0);

 $tableB=new easyTable($pdf,'%{10,25,15,20,15,15}','align:L{LC}; border:1; border-color:#BABABA; bgcolor:#EDF1E3; font-color:#000');

 $tableB->easyCell(utf8_decode("1"), 'rowspan:1; valign:M; align:C;');
 $tableB->easyCell(utf8_decode("Articulo de calidad innovadora con caracteristicas unicas"), 'rowspan:1; valign:M; align:C;');
 $tableB->easyCell(utf8_decode("100"), 'rowspan:1; valign:M; align:C;');
//  $tableB->easyCell(utf8_decode("FOTO"), 'rowspan:1; valign:M; align:C;');
 $tableB->easyCell("", 'img:img2.png,w50');
 $tableB->easyCell(utf8_decode("$ 450.00"), 'rowspan:1; valign:M; align:C;');
 $tableB->easyCell(utf8_decode("$ 4,500.00"), 'rowspan:1; valign:M; align:C;');
 $tableB->printRow();
 ...
 $tableB->easyCell(utf8_decode("100"), 'rowspan:1; valign:M; align:C;');
//  $tableB->easyCell(utf8_decode("FOTO"), 'rowspan:1; valign:M; align:C;');
 $tableB->easyCell("", 'img:img2.png,w30');
 $tableB->easyCell(utf8_decode("$ 450.00"), 'rowspan:1; valign:M; align:C;');
 $tableB->easyCell(utf8_decode("$ 4,500.00"), 'rowspan:1; valign:M; align:C;');
 $tableB->printRow();
...
//  $tableB->easyCell(utf8_decode("FOTO"), 'rowspan:1; valign:M; align:C;');
 ...
 $tableB->easyCell(utf8_decode("100"), 'rowspan:1; valign:M; align:C;');
//  $tableB->easyCell(utf8_decode("FOTO"), 'rowspan:1; valign:M; align:C;');
 $tableB->easyCell("", 'img:img.png,w30');
 $tableB->easyCell(utf8_decode("$ 450.00"), 'rowspan:1; valign:M; align:C;');
 $tableB->easyCell(utf8_decode("$ 4,500.00"), 'rowspan:1; valign:M; align:C;');
 $tableB->printRow();
...
//########################################################
 ...
 $tableB=new easyTable($pdf, 5, 'width:100; align:{LC}; l-margin:0 auto; border:1; font-color:#0066ff');

 $tableB->easyCell("JESUS A\n B\n C\n D\n E\n F\n", 'rowspan:5;');
...
//########################################################
 ...
 $tableB->easyCell("Cell 1BC BB", 'img:Pics/fpdflogo.gif,w30');
