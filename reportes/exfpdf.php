 ...
 class exFPDF extends FPDF{
   ...
   ************************************************************************/
   ...
   function Footer()
   {
      ...
      $this->SetFillColor(150,150,50);
      // Page number
      $this->SetTextColor(18,12,207);
      $this->MultiCell(170 ,4,'https://maqind.com/',0,'C',false);
      $this->SetFont('Arial','',9);
      $this->SetTextColor(0,0,0);
      $this->SetFont('Arial','B',9);
      $this->Cell(60 ,4,'Celular:',0,0,'R',false);
      $this->SetFont('Arial','',9);
      $this->Cell(20 ,4,'951365246:',0,0,'C',false);
      $this->SetFont('Arial','B',9);
      $this->Cell(10 ,4,'Email:',0,0,'C',false);
      $this->SetTextColor(18,12,207);
      $this->SetFont('Arial','U',9);
      $this->Cell(80 ,4,'ventas@maqind.com',0,1,'L',false);
      $this->SetTextColor(0,0,0);
      $this->SetFont('Arial','B',10);
      $this->Cell(0,5,'MAQIND S.A.C. - 20603855800',0,0,'C');
   }
