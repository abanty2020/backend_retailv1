               ...
               <div class="col-md-12">
                  <div class="box box-primary">
                     ...
                     <div class="panel-body table-responsive" id="listadoregistros">
                        <table id="tbllistado_atendido" class="table table-striped table-bordered">
                           <thead id="headuser">
                              <th>Nº Pedido</th>
                              <th>Fecha</th>
                              <th>Cliente</th>
         ...
         <div class="modal-dialog modal-lg">
            <div class="modal-content">
               <div class="modal-header" style="background: #3c8dbc; color:white; cursor: move;">
                  ...
                  <h4 class="modal-title"><i class="fa fa-book"></i> Pedidos Atendidos</h4>
               </div>
                  ...
                  <form name="formulario" id="formulario" method="POST">
                     ...
                     <div class="row">
                           ...
                           <div class="col-lg-3 text-right">
                              <div style="display:none;" class="" id="alertMsg">
